...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex">
      {/* Sidebar */}
      <div className={`${showSessions ? 'w-80' : 'w-0'} transition-all duration-300 border-r border-gray-800 flex flex-col overflow-hidden`}>
        <div className="p-4 border-b border-gray-800">
          <h2 className="text-white font-semibold mb-3">Chat History</h2>
          <button
            onClick={startNewChat}
            className="w-full px-4 py-2 bg-gradient-to-br from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-500 hover:to-pink-500 transition-all"
          >
            + New Chat
          </button>
        </div>
